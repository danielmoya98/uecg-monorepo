      ...
      <td className="px-4 py-3.5 border-r border-uecg-line text-center">
        {space.isActive ? (
          <span className="inline-flex items-center text-[9px] font-black uppercase tracking-widest text-green-700 bg-green-50 border border-green-200 px-2.5 py-1 shadow-sm">
            <span className="w-1.5 h-1.5 bg-green-500 mr-2 rounded-full animate-pulse"></span> ACTIVO
          </span>
        ) : (
          <span className="inline-flex items-center text-[9px] font-black uppercase tracking-widest text-red-700 bg-red-50 border border-red-200 px-2.5 py-1 shadow-sm">
            <span className="w-1.5 h-1.5 bg-red-500 mr-2 rounded-full"></span> INACTIVO
          </span>
        )}
      </td>
            ...
            {isOpen && (
              <div className="absolute right-0 top-8 w-40 bg-white border border-uecg-line shadow-2xl z-20 flex flex-col text-left animate-in fade-in zoom-in-95 duration-200">
                ...
                <button
                  ...
                  className="flex items-center gap-2.5 px-3 py-2.5 text-[10px] font-bold uppercase tracking-widest hover:bg-uecg-blue hover:text-white transition-colors outline-none cursor-pointer text-left w-full"
                >
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {isPending ? (
              ...
              <tr>
                <td colSpan={columnCount} className="text-center py-20 bg-white">
                  <div className="relative w-20 h-20 mx-auto mb-4 opacity-55">
                    <div className="absolute inset-0 border-4 border-uecg-line rotate-45"></div>
                    <div className="absolute inset-2 flex items-center justify-center bg-white border border-uecg-line">
                      <MapPin className="w-6 h-6 text-uecg-gray" />
                    </div>
                  </div>
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest text-uecg-gray">
                    Intente cambiar los filtros o el término de búsqueda.
                  </p>
                </td>
              </tr>
            ) : (
