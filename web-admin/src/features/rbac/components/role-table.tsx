...
export const RoleTable = ({ roles, onAction }: RoleTableProps) => {
  if (roles.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center border-2 border-dashed border-uecg-line bg-white shadow-sm">
        <span className="text-sm font-bold text-uecg-gray uppercase tracking-widest">
          No se encontraron roles coincidentes en el sistema.
        </span>
      </div>
    )
  }
  ...
  return (
    <div className="border border-uecg-line bg-white pb-16 shadow-sm overflow-hidden animate-in fade-in duration-300">
